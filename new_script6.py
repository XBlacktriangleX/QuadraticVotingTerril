...
st.title('Robotic Terril Forming Voting System')

# User information
name = st.text_input('Name')
age = st.number_input('Age', min_value=0, max_value=120, step=1)

st.header('Voting in x-axis')
...
results_directory = '/content/drive/My Drive/voting_results'
